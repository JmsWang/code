package com.example.fragment.courseFragments;
...
public class CourseAddFragment extends BaseFragment {
	...
	protected void initEvents() {
		...
		final String current_accoutnt = pref.getString("name", "");// 这里name就是用户当前的账号啦
	...
	private int readCurrrentTerm() {
		pref = getActivity().getSharedPreferences("data", Context.MODE_PRIVATE);
		String current_accoutnt = pref.getString("name", "");// 这里name就是用户当前的账号啦
